    ...
    public static class SeedData
    {
        public static void Initialize(IServiceProvider serviceProvider)
        {
                                ...
                                DbContextOptions<ApplicationDbContext>>()))
            {
                ...
                context.Storyboards.Add(new Storyboard { Story = "\"I know where I’m going, but thank you,\" you say. The little man gives you a respectful nod and you part on good terms. <br/> After a long stretch of walking you see a dark shape under the trees ahead and realize it’s a wolf. Though seated, it’s very large, and it’s looking at you. <br/> You: ", Option1 = "Give food", NextStoryboardID1 = 9, Option2 = "Back away slowly", NextStoryboardID2 = 7 });
